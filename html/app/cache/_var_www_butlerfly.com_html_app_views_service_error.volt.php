    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="padding-top: 25px">Apologies!</h2>
                <p style="font-size: 30px" class="lead">Our system is temporarily unavailable.<br/>

                    We're working on restoring full functionality.<br/>
