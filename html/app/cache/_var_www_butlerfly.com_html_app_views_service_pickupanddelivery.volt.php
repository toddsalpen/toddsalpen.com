...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <!-- Pickup & Delivery Service Request  Section -->
    <section id="portfolio">
        ...
        <div class="container">
            ...
            <div class="row-half text-left col-md-12">
                <div class="row-half form-inline">
                    <div class="form-group col-md-12">
                        <p>What type of vehicle do you need?</p>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('vehicle1'); ?>
                        <label class="radio inline control-label" for="vehicle1">Pickup truck</label>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('vehicle2'); ?>
                        <label class="radio inline control-label" for="vehicle2">Cargo van</label>
                    </div>
                </div>
            ...
            <div class="row-half text-left col-md-6">
                <div class="row-half text-center col-md-12">
                    <h4 class="form-group service-heading">Pickup location</h4>
                </div>
                <div class="form-group col-md-12">
            ...
            <div class="row-half text-left col-md-6">
                <div class="row-half text-center col-md-12">
                    <h4 class="form-group service-heading">Delivery location</h4>
                </div>
                <div class="form-group col-md-12">
                    <label for="address">Address</label>
                    <?php echo $form->render('addressB'); ?>
                </div>
                <div class="form-group col-md-12">
                    <label for="city">City</label>
                    <?php echo $form->render('cityB'); ?>
                </div>
                <div class="form-group col-md-12">
                    <label for="zipcode">Zip code</label>
                    <?php echo $form->render('zipcodeB', array('value' => $zipcode)); ?>
                </div>
            </div>
