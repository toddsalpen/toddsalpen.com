    ...
    <section id="availability">
        ...
        <div class="row container">
            ...
            <div class="row-half text-center form-group">
                ...
                <div class="col-md-2"><?php echo $form->render('zipcode'); ?></div>
                <div class="col-md-5">&nbsp;</div>
            </div>
            <div class="row-half text-center form-group col-md-4 col-md-offset-4">
                <?php echo $form->render('service', array('value' => $index)); ?>
                <?php echo $form->render('Next', array('class' => 'btn btn-default')); ?>
            </div>
