            ...
            <div class="row-half text-left col-md-12">
                <div class="row form-inline">
                    ...
                    <div class="form-group col-md-2">
                        <?php echo $form->render('loading'); ?><span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Loading</span>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('unloading'); ?><span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Unloading</span>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('packing'); ?><span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Packing</span>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('unpacking'); ?><span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Unpacking</span>
                    </div>
                    <div class="form-group col-md-2">
                        <?php echo $form->render('organizing'); ?><span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Organizing</span>
                    </div>
                </div>
