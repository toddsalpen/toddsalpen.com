...
class YardMaintenanceServiceForm extends Form{
    ...
    public function initialize(){
        ...
        /* --------  Lawn mowing  -------- */
        /* --------  -----------  -------- */
        $lawnmowing = new Check('lawnmowing',['class'=>'btn btn-default']);
        $this->add($lawnmowing);


        /* --------  Bush trimming  -------- */
        /* --------  -------------  -------- */
        $bushtrimming = new Check('bushtrimming',['class'=>'btn btn-default']);
        $this->add($bushtrimming);


        /* --------  Weed removal  -------- */
        /* --------  ------------  -------- */
        $weedremoval = new Check('weedremoval',['class'=>'btn btn-default']);
        $this->add($weedremoval);


        /* --------  Leaf sweeping  -------- */
        /* --------  -------------  -------- */
        $leafsweeping = new Check('leafsweeping',['class'=>'btn btn-default']);
        $this->add($leafsweeping);


        /* --------  Stump removal  -------- */
        /* --------  -------------  -------- */
        $stumpremoval = new Check('stumpremoval',['class'=>'btn btn-default']);
        $this->add($stumpremoval);


        /* --------  Planting  -------- */
        /* --------  --------  -------- */
        $planting = new Check('planting',['class'=>'btn btn-default']);
        $this->add($planting);
