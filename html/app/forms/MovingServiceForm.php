...
class MovingServiceForm extends Form{
    ...
    public function initialize(){
        ...
        /* --------  Helpers  -------- */
        /* --------  -------  -------- */
        $helpers = new Numeric('helpers',['required'=>'true','class'=>'form-control','style'=>'width:60px','value'=>1]);
        $this->add($helpers);


        /* --------  Loading  -------- */
        /* --------  -------  -------- */
        $loading = new Check('loading',['class'=>'btn btn-default']);
        $this->add($loading);


        /* --------  Unloading  -------- */
        /* --------  ---------  -------- */
        $unloading = new Check('unloading',['class'=>'btn btn-default']);
        $this->add($unloading);


        /* --------  Packing  -------- */
        /* --------  -------  -------- */
        $packing = new Check('packing',['class'=>'btn btn-default']);
        $this->add($packing);


        /* --------  Unpacking  -------- */
        /* --------  ---------  -------- */
        $unpacking = new Check('unpacking',['class'=>'btn btn-default']);
        $this->add($unpacking);


        /* --------  Organizing  -------- */
        /* --------  ----------  -------- */
        $organizing = new Check('organizing',['class'=>'btn btn-default']);
        $this->add($organizing);
