...
class PickupServiceForm extends Form{
    ...
    public function initialize(){
        ...
        /* --------  Type of Vehicle  -------- */
        /* --------  ---- -- -------  -------- */
        $vehicle1 = new Radio('vehicle1',['name'=>'vehicle','required'=>'true','class'=>'form-control','value'=>'Pickup Truck']);
        $this->add($vehicle1);
        $vehicle2 = new Radio('vehicle2',['name'=>'vehicle','required'=>'true','class'=>'form-control','value'=>'Cargo Van']);
        $this->add($vehicle2);
        ...
        /* --------  Address A  -------- */
        /* --------  ------- -  -------- */
        $address = new Text('address',['required'=>'true','class'=>'form-control','pattern'=>'(.+)','title'=>'Please enter your address']);
        $this->add($address);
        ...
        /* --------  Address B  -------- */
        /* --------  ------- -  -------- */
        $addressB = new Text('addressB',['required'=>'true','class'=>'form-control','pattern'=>'(.+)','title'=>'Please enter your address']);
        $this->add($addressB);


        /* --------  City B  -------- */
        /* --------  ---- -  -------- */
        $cityB  = new Text('cityB',['required'=>'true','class'=>'form-control','pattern'=>'(.+)','title'=>'Please enter your city']);
        $this->add($cityB);


        /* --------  Zip Code B  -------- */
        /* --------  --- ---- - -------- */
        //48188, 48331, 48332, 48333, 48334, 48335, 48336, 48374, 48375, 48377
        $zipcodeB = new Select('zipcodeB',[
            '48150'=>'48150',
            '48152'=>'48152',
            '48154'=>'48154',
            '48167'=>'48167',
