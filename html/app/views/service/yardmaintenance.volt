...
{% block content %}
    ...
    <!-- Yard Maintenance Service Request  Section -->
            ...
            <div class="row-half text-left col-md-12">
                <div class="row form-inline">
                    ...
                    <div class="form-group col-md-4">
                        {{ form.render('lawnmowing') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Lawn mowing</span>
                    </div>
                    <div class="form-group col-md-4">
                        {{ form.render('bushtrimming') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Bush trimming</span>
                    </div>
                    <div class="form-group col-md-4">
                        {{ form.render('weedremoval') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Weed removal</span>
                    </div>
                    <div class="form-group col-md-4">
                        {{ form.render('leafsweeping') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Leaf sweeping</span>
                    </div>
                    <div class="form-group col-md-4">
                        {{ form.render('stumpremoval') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Stump removal</span>
                    </div>
                    <div class="form-group col-md-4">
                        {{ form.render('planting') }}<span>&nbsp;</span><span style="font-size: medium; padding-right: 25px;"> Planting</span>
                    </div>
                </div>
